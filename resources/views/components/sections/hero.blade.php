...
<section
    class="relative w-full mt-20 overflow-hidden min-h-[calc(100vh-15rem)] lg:h-screen flex items-center justify-center py-12 lg:py-0">
                ...
                @foreach ($slides as $slide)
                    <div class="swiper-slide">
                        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
                            ...
                            <!-- Left Hero Content -->
                            <div
                                class="lg:col-span-6 z-10 text-center md:text-left mx-auto lg:mx-0 max-w-xl lg:max-w-none">
                                <span
                                    ...
                                    {{ $slide['eyebrow'] }}
                                    <i data-lucide="heart"
                                        class="w-4 h-4 sm:w-5 sm:h-5 text-[var(--color-primary)] fill-none"></i>
                                </span>
                                ...
                                <div
                                    class="flex items-center justify-center lg:justify-start gap-2 mb-4 sm:mb-6 text-[var(--color-secondary)]">
                                    <span class="h-[1px] w-10 lg:w-24 bg-[var(--color-secondary)]/40"></span>
                                    <i data-lucide="heart" class="w-5 h-5"></i>
                                    <span class="h-[1px] w-20 lg:w-24 bg-[var(--color-secondary)]/40"></span>
                                </div>

                                <p
                                    class="text-sm sm:text-base lg:text-lg text-[var(--color-body)] leading-relaxed mb-6 sm:mb-8">
                                    {{ $slide['description'] }}
                                </p>
