    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            @foreach($testimonials as $item)
                <div class="bg-white p-8 rounded-3xl border border-[var(--color-border)] shadow-xs flex flex-col justify-between">
                    <div>
                        <!-- Rating Stars -->
                    ...
                    <div class="flex items-center gap-4 pt-4 border-t border-[var(--color-border)]/60">
                        <div class="w-10 h-10 rounded-full overflow-hidden border border-[var(--color-border)] shrink-0">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-[var(--color-body)]">{{ $item['city'] }} • <span class="text-[var(--color-secondary)] font-medium">{{ $item['occasion'] }}</span></p>
                        </div>
                    </div>
                </div>
            @endforeach
