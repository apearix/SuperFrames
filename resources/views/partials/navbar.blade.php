@php
    $navigation = include resource_path('data/navigation.php');
@endphp
...
<div x-data="{ open: false }" @toggle-mobile-menu.window="open = !open" @open-mobile-menu.window="open = true"
    @close-mobile-menu.window="open = false" @keydown.escape.window="open = false" x-show="open"
    ...
    <div x-show="open" x-transition:enter="transition-opacity ease-linear duration-300"
        ...
        x-transition:leave-end="opacity-0" class="fixed inset-0 bg-black/60 backdrop-blur-xs" @click="open = false">
    </div>
    ...
    <div x-show="open" x-transition:enter="transition ease-in-out duration-300 transform"
        ...
        <div>
            ...
            <nav class="p-6 flex flex-col gap-3">
                ...
                <a href="/shop-by-occasion" @click="open = false"
                    ...
                    by Occasion</a>
                <a href="/shop-by-frame-style" @click="open = false"
                    class="text-sm font-semibold text-[var(--color-primary)] py-2 border-b border-[var(--color-border)]/60 hover:text-[var(--color-secondary)] transition-colors">Shop
                    by Frame Style</a>
                <a href="/best-sellers" @click="open = false"
