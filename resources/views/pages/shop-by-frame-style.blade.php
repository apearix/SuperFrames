...
@section('meta_description', 'Explore our handcrafted frame styles, from 3D Shadow Boxes to Quilling Name Frames and Mini Desk Frames.')
                            ...
                            <div class="space-y-2 mb-6">
                                @foreach(array_slice($style['features'], 0, 3) as $feature)
                                    <div class="flex items-center gap-2 text-xs text-[var(--color-heading)]">
                                        <i data-lucide="check-circle-2" class="w-3.5 h-3.5 text-[var(--color-secondary)] shrink-0"></i>
                                        <span>{{ $feature }}</span>
                                    </div>
                                @endforeach
                            </div>
