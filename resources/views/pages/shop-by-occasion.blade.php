        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            <div class="text-center max-w-2xl mx-auto mb-12">
                ...
                <p class="text-[var(--color-body)] text-sm sm:text-base leading-relaxed">
                    Celebrate birthdays, anniversaries, weddings, newborn arrivals, and every special moment with a
                    personalized handcrafted photo frame.
                </p>
            </div>
                ...
                @foreach ($occasions as $occ)
                    <div
                        ...
                        <div class="relative h-60 overflow-hidden bg-[var(--color-section)]">
                            <img src="{{ asset($occ['banner_image'] ?? 'https://images.unsplash.com/photo-1518895949257-7621c3c786d7?q=80&w=1000') }}"
                                alt="{{ $occ['title'] }}"
