...
@section('meta_description', 'Discover creative ideas, gifting inspiration, and thoughtful ways to preserve life\'s most cherished memories.')
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            @foreach($blogs as $blog)
                <div class="group relative rounded-2xl overflow-hidden bg-black aspect-4/5 shadow-md flex flex-col justify-end p-6">
                    <img src="{{ asset($blog['image']) }}" alt="{{ $blog['title'] }}" class="absolute inset-0 w-full h-full object-cover opacity-80 group-hover:scale-105 transition-transform duration-500">
                    ...
                    <div class="relative z-10 text-white">
                        ...
                        <a href="{{ $blog['link'] }}" class="inline-flex items-center gap-1.5 text-xs font-semibold text-white hover:text-[var(--color-secondary)] transition-colors">
                            <span>Read More</span>
